...
$icon = <<<SVG
<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 297 297" style="width: 1rem; height:1rem; fill: currentColor"><title>Bin</title><defs/>
...
echo
'<a href="#" class="js_modPublicfolder header-item-content" title="Create Public Folder" data-token="', $app->getSession()->getFormToken(), '" data-url="', Uri::root(false), '" disabled>',
'<div class="header-item-icon" aria-hidden="true"><div class="w-auto">', $icon, '</div></div>',
'<div class="header-item-text">Create Public Folder</div>',
'</a>';
